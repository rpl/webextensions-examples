...
const BUTTON_ID = "bootstrap-transition-addon--toolbar-button";
const BUTTON_ICON_URL = "chrome://bootstrap-transition-addon/content/icons/icon-32.png";

const PANEL_ID = "bootstrap-transition-addon--popup-panel";
